...
int
_minify_proc_1 (minify_in  *argp, void *result, struct svc_req *rqstp)
{
...
{
	union {
		minify_in minify_proc_1_arg;
	} argument;
	union {
		minify_in minify_proc_1_res;
	} result;
	bool_t retval;
	...
	case MINIFY_PROC:
		...
		_xdr_result = (xdrproc_t) xdr_minify_in;
